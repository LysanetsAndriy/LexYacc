...
static const char *const yytname[] =
{
  ...
  "'/'", "'^'", "'%'", "'|'", "UMINUS", "FLOATNUM", "ANS", "NEWLINE",
  "'('", "')'", "$accept", "calclist", "expression", YY_NULLPTR
};
...
{
      -6,    16,    -6,    40,    40,    -6,    -6,    -6,    40,    34,
      -6,    52,    28,    40,    40,    40,    40,    40,    40,    -6,
      -6,    -6,     1,     1,    -5,    -5,    -4,    -6
};
...
{
      10,    11,    17,    18,    18,    12,    15,    16,    17,    18,
      22,    23,    24,    25,    26,    27,     2,     0,     0,     0,
       3,     0,     0,     0,     0,     4,     0,     5,     6,     7,
       8,    13,    14,    15,    16,    17,    18,    13,    14,    15,
      16,    17,    18,    21,     3,     0,     0,    19,     0,     4,
       0,     5,     6,     0,     8,    13,    14,    15,    16,    17,
      18,    20
};
...
{
       3,     4,     7,     8,     8,     8,     5,     6,     7,     8,
      13,    14,    15,    16,    17,    18,     0,    -1,    -1,    -1,
       4,    -1,    -1,    -1,    -1,     9,    -1,    11,    12,    13,
      14,     3,     4,     5,     6,     7,     8,     3,     4,     5,
       6,     7,     8,    15,     4,    -1,    -1,    13,    -1,     9,
      -1,    11,    12,    -1,    14,     3,     4,     5,     6,     7,
       8,     9
};
...
{
       0,    17,     0,     4,     9,    11,    12,    13,    14,    18,
      18,    18,    18,     3,     4,     5,     6,     7,     8,    13,
       9,    15,    18,    18,    18,    18,    18,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* calclist: calclist expression NEWLINE  */
#line 36 "calculator.y"
                                  {
            calc_data.ans = eval((yyvsp[-1].a));
...
#line 65 "calculator.y"
                                { (yyval.a) = new_ast('/', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1410 "calculator.tab.c"
    break;

  case 9: /* expression: expression '^' expression  */
#line 66 "calculator.y"
                                { (yyval.a) = new_ast('^', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1416 "calculator.tab.c"
    break;

  case 10: /* expression: expression '%' expression  */
#line 67 "calculator.y"
                                { (yyval.a) = new_ast('%', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1422 "calculator.tab.c"
    break;

  case 11: /* expression: '|' expression '|'  */
#line 68 "calculator.y"
                                { (yyval.a) = new_ast('|', (yyvsp[-1].a), NULL); }
#line 1428 "calculator.tab.c"
    break;

  case 12: /* expression: '(' expression ')'  */
#line 69 "calculator.y"
                                { (yyval.a) = (yyvsp[-1].a); }
#line 1434 "calculator.tab.c"
    break;

  case 13: /* expression: '-' expression  */
#line 70 "calculator.y"
                                  { (yyval.a) = new_ast('M', (yyvsp[0].a), NULL); }
#line 1440 "calculator.tab.c"
    break;

  case 14: /* expression: FLOATNUM  */
#line 71 "calculator.y"
                                { (yyval.a) = new_num((yyvsp[0].num)); }
#line 1446 "calculator.tab.c"
    break;

  case 15: /* expression: ANS  */
#line 72 "calculator.y"
                                { (yyval.a) = new_num((yyvsp[0].num)); }
#line 1452 "calculator.tab.c"
    break;


#line 1456 "calculator.tab.c"
